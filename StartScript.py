...
Зависимости:
- requests>=2.25.0
- argparse (входит в стандартную библиотеку Python 3.2+)

Дополнительные требования:
- Для работы скрипта требуется внешняя утилита VanitySearch.exe
- Доступ к интернету для API запросов к honestpool.ru
- Операционная система: Windows (из-за использования .exe) или совместимая
- Достаточное дисковое пространство для временных файлов
- GPU для эффективной работы VanitySearch

Описание зависимостей:
- requests: для HTTP запросов к API пула
- argparse: для обработки аргументов командной строки
- re, json, os, time: стандартные модули Python
"""
